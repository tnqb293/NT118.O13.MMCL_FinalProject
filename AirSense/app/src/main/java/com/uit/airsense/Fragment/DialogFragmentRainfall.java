...
public class DialogFragmentRainfall extends DialogFragment {
    DialogFragment hourFragment, dayFragment, weekFragment, monthFragment;
    AnimatedBottomBar navBar;
    public static DialogFragmentRainfall newInstance() {
        return new DialogFragmentRainfall();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hourFragment = new DialogFragmentHourRainfall();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setCancelable(true);
        dayFragment = new DialogFragmentDayRainfall();
        weekFragment = new DialogFragmentWeekRainfall();
        monthFragment = new DialogFragmentMonthRainfall();
        InitViews(view);
        InitEvents();
    }
    @Override
