...
public class DialogFragmentMonthRainfall extends DialogFragment {
    ...
    private void InitEvent() {
        ...
        loadRainfallData(current); // Gọi API ban đầu khi Fragment được khởi tạo
                            ...
                            TimePickerDialog timePickerDialog = new TimePickerDialog(
                                    ...
                                    new TimePickerDialog.OnTimeSetListener() {
                                        ...
                                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                            ...
                                            loadRainfallData(selectedTimeInMillis); // Gọi API khi người dùng chọn ngày và giờ mới
                                        }
                                    },
                                    hour,
                                    minute,
    ...
    private void loadRainfallData(long time) {
        JsonObject newRequest = requestChartHour(time);
        APIManager.getRainfallChart(newRequest, new DataChartCallback() {
            @Override
