...
public class DialogFragmentWindSpeed extends DialogFragment {
    DialogFragment hourFragment, dayFragment, weekFragment, monthFragment;
    AnimatedBottomBar navBar;
    public static DialogFragmentWindSpeed newInstance() {
        return new DialogFragmentWindSpeed();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hourFragment = new DialogFragmentHourWindSpeed();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setCancelable(true);
        dayFragment = new DialogFragmentDayWindSpeed();
        weekFragment = new DialogFragmentWeekWindSpeed();
        monthFragment = new DialogFragmentMonthWindSpeed();
        InitViews(view);
        InitEvents();
    }
    @Override
