...
public class DialogFragmentHumidity extends DialogFragment{
    DialogFragment hourFragment, dayFragment, weekFragment, monthFragment;
    AnimatedBottomBar navBar;
    public static DialogFragmentHumidity newInstance() {
        return new DialogFragmentHumidity();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hourFragment = new DialogFragmentHourHumidity();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setCancelable(true);
        dayFragment = new DialogFragmentDayHumidity();
        weekFragment = new DialogFragmentWeekHumidity();
        monthFragment = new DialogFragmentMonthHumidity();
        InitViews(view);
        InitEvents();
    }
    @Override
